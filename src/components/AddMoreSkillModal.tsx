...
import { CreateSkillPayload } from "@/services/skillService";

interface AddMoreSkillModalProps {
  isOpen: boolean;
...
export default function AddMoreSkillModal({
  isOpen,
  isSubmitting,
  errorMessage,
  categoryName,
      ...
      >
        <div className="mb-6 flex items-start justify-between gap-4">
          <div>
            ...
            <h2 className="mt-3 text-2xl font-semibold text-white">Add More Skill</h2>
            <p className="mt-2 text-sm text-slate-400">
              Add a new skill inside the currently opened category.
            </p>
          </div>
